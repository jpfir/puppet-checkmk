  ...
  case $facts['os']['family'] {
    'Debian': {
      ...
      exec { 'register checkmk agent':
        command => "/usr/bin/cmk-agent-ctl register --hostname ${checkmk::hostname} --server ${checkmk::agent_download_host} --site ${checkmk::site_name} --user automation --password ${automation_user_password} --trust-cert",
